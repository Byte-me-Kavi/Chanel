<header class="border-b border-gray-200">
    <div class="py-4">
        <div class="px-4 mx-auto max-w-[1600px]">
            <div class="flex justify-between items-center">
                ...
                <div class="flex gap-6 items-center">
                    <a href="{{ route('search') }}" aria-label="Find" class="text-black transition-opacity hover:opacity-60">
                    ...
                    <div class="relative group">
                        <button class="flex gap-2 items-center text-black transition-opacity hover:opacity-60">
                        ...
                        <div class="invisible absolute right-0 top-full z-50 mt-2 w-48 bg-white border border-gray-200 shadow-lg opacity-0 transition-all group-hover:visible group-hover:opacity-100">
                    ...
                    @else
                    <a href="{{ route('login') }}" aria-label="Account" class="text-black transition-opacity hover:opacity-60">
                         <svg viewBox="0 0 24 24" class="w-6 h-6 fill-current"><path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z" /></svg>
                    </a>
                    @endauth
                    @auth
                    <a href="{{ route('wishlist.index') }}" aria-label="Wishlist" class="text-black transition-opacity hover:opacity-60">
                    ...
                    @else
                    <a href="{{ route('login') }}" aria-label="Wishlist" class="text-black transition-opacity hover:opacity-60">
                        <svg viewBox="0 0 24 24" class="w-6 h-6 fill-current"><path d="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z" /></svg>
                    </a>
                    @endauth
                    
                    <a href="{{ route('cart.index') }}" class="relative text-black transition-opacity hover:opacity-60" aria-label="Shopping Bag">
    ...
    <div class="hidden border-t border-b border-gray-200 md:block">
        <nav class="px-4 mx-auto max-w-[1400px]">
            <ul class="flex gap-8 justify-center items-center">
                ...
                <li><a href="{{ route('product') }}" class="block py-4 text-[13px] font-semibold uppercase tracking-[1px] hover:underline relative group">Collections <span class="absolute bottom-3 left-0 w-full h-px bg-black scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span></a></li>
